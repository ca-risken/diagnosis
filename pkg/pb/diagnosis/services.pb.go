...
type PutDiagnosisRequest struct {
	Diagnosis            *DiagnosisForUpsert `protobuf:"bytes,1,opt,name=diagnosis,proto3" json:"diagnosis,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *DeleteDiagnosisRequest) GetDiagnosisId() uint64 {
	if m != nil {
		return m.DiagnosisId
	}
	return 0
...
func (m *GetDiagnosisDataSourceRequest) GetDiagnosisDataSourceId() uint64 {
	if m != nil {
...
type PutDiagnosisDataSourceRequest struct {
	DiagnosisDataSource  *DiagnosisDataSourceForUpsert `protobuf:"bytes,1,opt,name=diagnosis_data_source,json=diagnosisDataSource,proto3" json:"diagnosis_data_source,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *DeleteDiagnosisDataSourceRequest) GetDiagnosisDataSourceId() uint64 {
	if m != nil {
		return m.DiagnosisDataSourceId
	}
	return 0
...
func (m *StartDiagnosisRequest) GetRelDiagnosisDataSourceId() uint64 {
	if m != nil {
...
type ListRelDiagnosisDataSourceRequest struct {
	...
	DiagnosisId           uint64   `protobuf:"varint,4,opt,name=diagnosis_id,json=diagnosisId,proto3" json:"diagnosis_id,omitempty"`
	DiagnosisDataSourceId uint64   `protobuf:"varint,5,opt,name=diagnosis_data_source_id,json=diagnosisDataSourceId,proto3" json:"diagnosis_data_source_id,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}
...
func (m *ListRelDiagnosisDataSourceRequest) GetDiagnosisId() uint64 {
	if m != nil {
		return m.DiagnosisId
	}
	return 0
...
func (m *ListRelDiagnosisDataSourceRequest) GetDiagnosisDataSourceId() uint64 {
	if m != nil {
		return m.DiagnosisDataSourceId
	}
	return 0
...
func (m *GetRelDiagnosisDataSourceRequest) GetRelDiagnosisDataSourceId() uint64 {
	if m != nil {
		return m.RelDiagnosisDataSourceId
	}
	return 0
...
type PutRelDiagnosisDataSourceRequest struct {
	RelDiagnosisDataSource *RelDiagnosisDataSourceForUpsert `protobuf:"bytes,1,opt,name=rel_diagnosis_data_source,json=relDiagnosisDataSource,proto3" json:"rel_diagnosis_data_source,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                         `json:"-"`
	XXX_unrecognized       []byte                           `json:"-"`
	XXX_sizecache          int32                            `json:"-"`
}
...
func (m *DeleteRelDiagnosisDataSourceRequest) GetRelDiagnosisDataSourceId() uint64 {
	if m != nil {
		return m.RelDiagnosisDataSourceId
	}
	return 0
...
var fileDescriptor_8e16ccb8c5307b32 = []byte{
	...
	,
}
